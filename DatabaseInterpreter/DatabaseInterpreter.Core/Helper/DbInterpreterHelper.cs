...
namespace DatabaseInterpreter.Core
{
    ...
    {
        public static DbInterpreter GetDbInterpreter(DatabaseType dbType, ConnectionInfo connectionInfo, DbInterpreterOption option = null)
        {
            if (option == null)
            {
                option = new DbInterpreterOption();
            }
