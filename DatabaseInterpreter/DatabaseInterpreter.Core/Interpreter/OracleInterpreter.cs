...
namespace DatabaseInterpreter.Core
{
    public class OracleInterpreter : DbInterpreter
    {
        ...
        /// <summary>
        /// true is only for: GENERATED BY DEFAULT AS IDENTITY,
        ...
        public override string StringCheckNullFunctionName => "NVL";
        ...
        public override string ParseColumn(Table table, TableColumn column)
        {
            ...
            else
            {
                ...
                string identityClause = (this.Option.TableScriptsGenerateOption.GenerateIdentity && column.IsIdentity && !isLowDbVersion ? $"GENERATED BY DEFAULT AS IDENTITY" : "");
