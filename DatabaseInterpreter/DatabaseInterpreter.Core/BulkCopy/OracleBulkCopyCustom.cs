...
{
    public class OracleBulkCopyCustom : IDisposable
    {
        ...
        public OracleBulkCopyCustom(string connectionString) : this(new OracleConnection(connectionString))
        {
            this._ownsTheConnection = true;
        }

        public OracleBulkCopyCustom(OracleConnection connection) : this(connection, null) { }

        public OracleBulkCopyCustom(OracleConnection connection, OracleTransaction transation = null)
        {
