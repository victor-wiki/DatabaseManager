    ...
    public partial class frmCompare : Form, IObserver<FeedbackInfo>
    {
        ...
        private async void Compare()
        {
            ...
            try
            {
                ...
                DbInterpreterOption sourceOption = new DbInterpreterOption() { GetTableAllObjects = true };
                DbInterpreterOption targetOption = new DbInterpreterOption() { GetTableAllObjects = true };
        ...
        private void LoadData()
        {
            ...
            if (roots.Count() == 1)
            {
                this.tlvDifferences.Expand(roots.First());
            }
        }
        ...
        private async Task GenerateOrSync(bool isSync, DbDifference difference = null)
        {
            ...
            try
            {
                ...
                if (!isSync)
                {
                    ...
                    {
                        scripts = dbSynchro.GenereateScriptDbObjectScripts(difference, targetDbOwner);
                    }
